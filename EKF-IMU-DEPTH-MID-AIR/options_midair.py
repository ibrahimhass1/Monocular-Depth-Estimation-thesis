...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--data_path",
                                 ...
                                 choices=["kitti", "midair"],
                                 default=os.path.join("MidAir/"))
        ...
        self.parser.add_argument("--export_pics",
                                 help="if set, saves prediction along with ground truth",
                                 action="store_true")
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_quater", "eigen_half", "eigen_three_quater", "eigen_zhou", "eigen_full", "odom", "benchmark", "test", "m4depth_midair"],
                                 default="m4depth_midair")
        ...
        self.parser.add_argument("--eval_split",
                                 type=str,
                                 default="eigen_midair",
                                 choices=[
                                    "eigen", "eigen_benchmark","eigen-midair", "benchmark", "odom_9", "odom_10","m4depth_midair", "scenario_cloudy", "scenario_sunny", "scenario_sunset", "scenario_foggy"],
